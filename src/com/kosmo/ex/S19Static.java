...
1. 다음 중 `static` 변수에 대한 설명으로 올바른 것은?
...
3. 클래스가 처음 참조될 때 JVM이 수행하는 작업으로 옳은 것은?
...
4. 다음 중 `new` 키워드를 사용할 때 발생하는 동작은?
...
6. `Student` 클래스를 여러 번 `new`로 생성하면, 다음 중 항상 하나만 존재하는 것은?
